...
<html>
    ...
    <body>
        ...
        <div class="row">
            ...
            <div class="large-12 columns">
                <form method="post" action="choose3.php">
                    <fieldset style="background-color: #f4f4f4 ; box-shadow:  #aaa">
                        ...
                        <div class="row">
                            <div class="small-3 columns">
                                <button name="Submit" type="submit" value="Submit">View History</button>
                            </div>
                        </div>
                    </fieldset>
                </form>
