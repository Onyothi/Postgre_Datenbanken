            ...
            <div class="large-12 columns">
                <form method="post" action="addlive.php" enctype="multipart/form-data" id="899762552" >
                    <fieldset style="background-color: #f4f4f4 ; box-shadow:  #aaa">
                        ...
                        <?php
                        if (isset($_POST["Tagc"]) && isset($_POST["Name"]) && isset($_POST["Type"]) && isset($_POST["sex"])
                                && isset($_POST["fcode"]) && isset($_POST["M_tag"]) && isset($_POST["farm"]) && isset($_POST["kraal"]) && isset($_POST["breed"]) &&
                                isset($_POST["status"]) && isset($_POST["dob"]) && isset($_POST["vet"])) {
                            $Tagc = $_POST["Tagc"];
                            $Cname = $_POST["Name"];
                            $Ctype = $_POST["Type"];
                            $Cmcode = $_POST["M_tag"];
                            ...
                            if (!empty($Tagc) && !empty($Cdob) && !empty($Cname) && $Ctype != "Select" && $Cstatus != "Sellect" && $Csex != "Select" && Cfarm != "Select" && Ckraal != "Select" && $Cbreed != "Select") {
                                if (LiveSt_exists($Tagc, $session_user_id) === FALSE) {
                                    ...
                                    $reg = date("Y.m.d");
                                    echo $Cmcode;
                                    $ins = Add_Livestock($Tagc, $Cname, $Ctype, $Csex, $Cfcode, $Cfarm, $Ckraal, $Cbreed, $Cstatus, $Cvet, $session_user_id, $Cdob, $burl, $turl, $Cmcode, $reg);
                                    if (!$ins) {
                        ...
                        <div class="row">
                            <div class="large-6  columns">
                                <label>Father's Tag Code
                                    <input name="fcode" type="text">
                                </label>
                            </div>
                            <div class="large-6  columns">
                                <label>Mother's Tag Code
                                    <input name="M_tag" type="text">
                                </label>
                            </div>
                        </div>
                        <div class="row">
